...
LEJEASIDE.insertAdjacentHTML("beforeend", `<br><br><h3>Udstyrvalg</h3><ul id="ekstraudstyr">`);
...
TOTALSIDE.insertAdjacentHTML("beforeend", `<br><h3>TOTAL ${sessionStorage.getItem('total')}</h3> inkl. moms`);
